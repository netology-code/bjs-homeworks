...
3. Самостоятельно вызывать функии не требудется, если это не требуется по заданию.
...
7. Опубликовать код в репозиторий homeworks с помощью команды `git push -u homeworks master`.
