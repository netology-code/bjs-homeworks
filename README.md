...
* Add .gitignore: None;
* Add a license: None;
После создания нажатия на кнопку `Create repository`, вы будете переведены на страницу вновь созданного репозитория.
...
2. Создайте директория на вашем компьютере, в которой вы планируете выполнять домашние задания.
...
2. Создайте файл с расширением `js`. Например: `main.js`
3. Выполнить задание.
