describe('Домашнее задание к занятию 2.3 «ООП в JS (ES6)»', () => {
  ...
  it('Задача №1 Создание печатного издания', () => {
  ...
  it('Задача №1 Починка печатного издания', () => {
    printItem.state = 90;
    printItem.fix();
    expect(printItem.state).toEqual(100);
  });  
  
  it('Задача №1 Геттер для свойства state', () => {
    printItem.state = 10;
  ...
  it('Задача №1 Создание объекта DetectiveBook', () => {
